...
{
    public partial class frmNetworkIvdOvd : Form
    {
        public frmNetworkIvdOvd()
        {
            InitializeComponent();
        }
        private frmHome parentForm;

        public frmNetworkIvdOvd(frmHome parentForm) : this()
        {
            this.parentForm = parentForm;
        }

        private void frmNetworkIvdOvd_Load(object sender, EventArgs e)
        {
            try
            {
