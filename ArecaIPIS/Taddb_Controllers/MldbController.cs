...
namespace ArecaIPIS.Server_Classes
{
    class MldbController
    {
        ...
        public static void MLDBsendData()
        {
        ...
        public static byte[] getMldbFullPacket(int packetIdentifier, string SourceipAdress, string destinationIpAdress, int packetSerialNumer, int packetType)
        {
            try
            {
